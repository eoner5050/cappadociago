export const tr = {
  ...
  hero: {
    ...
    description: "CappadociaGo ile unutulmaz gün doğumu sıcak hava balonu uçuşlarını, Göreme balon turlarını, Yeşil Tur, Kırmızı Tur, ATV turlarını ve havalimanı transferlerini keşfedin. Kapadokya maceranızı güvenli online rezervasyon ile planlayın.",
  ...
  footer: {
    ...
    copyright: "© 2026 CappadociaGo. Tüm hakları saklıdır.",
  },
  tourCards: [
    {
      category: "balloon",
